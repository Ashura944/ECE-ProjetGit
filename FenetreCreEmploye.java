 ...
 * 
 * Classe qui permet de créer un employé.
 */
public class FenetreCreEmploye extends JDialog implements ActionListener
{   
    ...
    // maConnex ci-dessous a été créé car si je passais bien maconnexion
     ...
     */
    public FenetreCreEmploye(FenetrePrincipale fenPrincipale,Connexion maconnexion) 
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==this.btValider){
            ...
            bRetour=listControlAction.controleChampsCreEmploye(this,maConnex);
            if(bRetour==true)
            {
